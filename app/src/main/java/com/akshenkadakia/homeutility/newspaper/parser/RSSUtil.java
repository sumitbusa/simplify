package com.akshenkadakia.homeutility.newspaper.parser;
...
public class RSSUtil {
	...
	public static String RSSFEEDURL = "http://www.pcworld.com/index.rss";
		...
		.setPositiveButton("OK", new DialogInterface.OnClickListener(){
			public void onClick(DialogInterface dialog, int whichButton){
				...
				//if(new UrlValidator().isValid(input.getText().toString())){
					...
					RSSFEEDURL = "http://www.pcworld.com/index.rss";
			//	}
				// Parse the new feed
				new LoadRSSFeed(context, RSSFEEDURL).execute();
			}
		})
		// Set the negative button actions4
